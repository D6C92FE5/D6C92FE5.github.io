...
if (page === 'mall') {
  chart = c3.generate({
    ...
    data: {
      x: 'x',
      columns: [['x', '2013-01-01', '2013-01-02', '2013-01-03', '2013-01-04', '2013-01-05'], ['mall', 30, 200, 100, 400, 150]],
      names: {
...
if (page === 'floor') {
  chart = c3.generate({
    ...
    data: {
      columns: [['1 层', 800], ['2 层', 400], ['3 层', 200], ['4 层', 100], ['5 层', 100]],
      type: 'pie'
    }
  });
}
...
if (page === 'shop') {
  chart = c3.generate({
    ...
    data: {
      columns: [['shop', 2.83, 3.44, 3.66, 4.58, 6.56, 6.85, 9.42, 9.54, 11.00, 15.73]],
      type: 'bar',
      names: {
